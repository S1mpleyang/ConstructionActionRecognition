...
def parse_opts():
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        'Dataset (TinyVIRAT: 26, activitynet: 200, kinetics: 400 or 600, ucf101: 101, hmdb51: 51)'
    )
    ...
    parser.add_argument(
        ...
        type=str,
        help='at_type',
        choices=["no_attention", "self_attention", "relation_attention", "distance_attention"],
    )
    ...
    parser.add_argument('--no_test',
                        action='store_true',
                        help='If true, testing is not performed.')
